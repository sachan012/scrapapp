         ...
         <?php if(!empty($rolename["role_id"]) && $rolename["role_id"] == 2 || $rolename["role_id"] == 1) { ?>
           ...
           <div class="col-md-3" style="display:none;">
            ...
            <div class="small-box bg-info">
              ...
              <div class="icon">
               <!--  <i class="ion ion-person"></i> -->
                <img src="<?php echo base_url();?>assets/uploads/dashboard_icon/supplier.png" class="img-responsive">
              </div>
              <a href="<?php echo base_url("staffentery/index/all");?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
