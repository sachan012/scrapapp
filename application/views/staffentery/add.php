            ...
            <div class="col-lg-8">
               ...
               <section class="content">
                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
                        <!-- Main content -->
                        <form action="<?php echo base_url('add-entery'); ?>" method="post" name="addentery" id="addentery" required>                          
                              <div class="form-group row">
                                 <label>Select Auction For Vehicle Entry(Material Code - Materia Type - Plant Code) <span style="color: red;">*</span></label>
                                 <select class="form-control" name="auction" required>
                                    <option value="">----Select Auction Details -----<option
                                    <?php foreach($auctionList as $list){?>
                                    <option value="<?php echo $list['id']?>"><?php echo ucfirst($list['material_code'])?>&nbsp;-&nbsp;<?php echo ucfirst($list['material_type'])?>&nbsp;-&nbsp;<?php echo ucfirst($list['plant_code'])?></option>  
                                    <?php }?>                               
                                 </select>                               
                              </div>                          
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter vehicle rgistration number" name="vehicle_rgistration" id="vehicle_rgistration" class="form-control" required>
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Driver" name="Driver" id="Driver" class="form-control" required>
                           ...
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter entry time." name="entry_time" id="entry_time" class="form-control entry_time" autocomplete="off"> 
							  ...
							  <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter exit time." name="exit_time" id="exit_time" class="form-control exit_time" autocomplete="off">
                              ...
                              <div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Weight" name="Weight" id="Weight" class="form-control" autocomplete="off">
							...
							<div class="col-md-6">
                                 <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Enter Weight" name="Weight_after" id="WeightLater" class="form-control" autocomplete="off">
                                    <?php echo form_error('Weight'); ?>
                                 </div>
                              </div>
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <textarea required name="scrap_dealer" id="scrap_dealer" class="form-control" rows="5" placeholder="Enter scrap_dealer details."></textarea>
