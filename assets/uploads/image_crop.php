...
if ($_SERVER['HTTP_HOST'] == 'localhost' || $_SERVER['HTTP_HOST'] == '127.0.0.1' || $_SERVER['HTTP_HOST'] == '49.50.118.191' || $_SERVER['HTTP_HOST'] == 'demo.triazinesoft.com')
    $project_name = 'finappnew';
else
    $project_name = '';
